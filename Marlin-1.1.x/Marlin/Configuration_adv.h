...
#define SPINDLE_LASER_ENABLE
  ...
  #define SPINDLE_LASER_POWERUP_DELAY   20   // delay in milliseconds to allow the spindle/laser to come up to speed/power
  #define SPINDLE_LASER_POWERDOWN_DELAY 20   // delay in milliseconds to allow the spindle to stop
  ...
  #define SPEED_POWER_SLOPE    1        //0.3922
  #define SPEED_POWER_INTERCEPT  0
